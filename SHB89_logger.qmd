...
2007-08-10 Added an if statement to correct reference temperatures below -28 with a polynomial. Also changed output so the year is added to the output.\
...
; NOTES: Soil temps in the LTER Shrub site treatment plots using an AM416 multiplexer. ; 2 strings per treatment with sur, 10, 20, 40 and 5 and 100 cm in cts. ; CT, NP, GH, GHF in block 2.
